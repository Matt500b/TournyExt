...
if(isset($_POST['type'])) {
    ...
    switch($switch) {
        case 'create_team':
            $team = new teams($db);
            $return_msg = $team->create_team($_POST['team_name'], $_POST['abb_team_name'], $_POST['p'], $_POST['website'], $_POST['team_logo'], $userID);
        ...
        case 'edit_profile':
            ...
            echo '<script>setTimeout(function(){window.location = "?view=profile&pid='.$username.'"}, 2000);</script>';
            break;
        default:
